...
$sql = "SELECT $table.id, $table.nama, $table_kategori.kategori, $table_golongan.golongan, $table_golongan.perlu_resep, $table.produsen, $table.harga, $table.stok, $table.gambar 
	FROM $table
