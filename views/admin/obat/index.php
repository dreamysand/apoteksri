...
<body class="relative min-h-screen pb-[200px] bg-fixed bg-no-repeat bg-center bg-cover bg-[#E7F4E4]">
	...
	<div class="container mx-auto p-6 mt-12">
		...
		<div class="mb-4">
	        <!-- Tombol Tambah Obat -->
	        <a href="insert.php?type=obat&page=<?php echo $page; ?>" class="bg-green-500 text-white px-6 py-2 rounded-lg hover:bg-green-600 transition duration-300">Tambah Obat</a>
	    </div>
				...
				<?php foreach ($result as $row): 
					...
					<tbody>
						<tr class="border-b">
							...
							<td class="py-2 px-4">
								<!-- Tombol Edit -->
								<a href="edit.php?type=obat&id=<?php echo $row['id'] ?>&page=<?php echo $page; ?>" class="text-blue-500 hover:text-blue-700 font-semibold">Edit</a> 
								|
    ...
    <script>
        function showDeleteAlert(id, page) {
            ...
            document.getElementById('deleteLink').setAttribute('href', 'delete.php?type=obat&id='+id+'&page='+page);
        }
