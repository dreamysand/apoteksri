...
<body class="bg-gray-100 relative min-h-screen pb-[200px] bg-fixed bg-no-repeat bg-center bg-cover">
	<!-- Navbar -->
	...
	<div class="mt-6 mx-2 p-2 rounded-lg">
		<div class="my-6 mx-2 grid grid-cols-1 md:grid-cols-3 gap-8">
			...
			<div class="bg-white p-6 rounded-lg shadow border-[1.5px] border-[#8F8F8F] hover:scale-[1.05] transition ease-in-out duration-[100ms] cursor-pointer">
				<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 200 200" class="h-[20em] w-[20em] mx-auto">
					<!-- Botol Obat -->
					...
					<rect x="75" y="75" width="50" height="30" fill="#FFEB3B" stroke="#FBC02D" stroke-width="2"/>
				  	...
				  	<!-- Simbol Salib pada Label -->
					<line x1="90" y1="85" x2="110" y2="85" stroke="red" stroke-width="3"/>
					<line x1="100" y1="75" x2="100" y2="95" stroke="red" stroke-width="3"/>

				  	<!-- Pil Bulat -->
				  	<circle cx="50" cy="150" r="10" fill="#FFC107" stroke="#FFA000" stroke-width="2"/>
					  
				 	<!-- Pil Kapsul -->
				  	<ellipse cx="140" cy="150" rx="8" ry="15" fill="#E91E63" stroke="#C2185B" stroke-width="2"/>
				  	<line x1="140" y1="135" x2="140" y2="165" stroke="#C2185B" stroke-width="2"/>
				</svg>
				<h3 class="text-2xl text-center font-semibold">Obat-Obatan</h3>
			...
			<div class="bg-white p-6 rounded-lg shadow border-[1.5px] border-[#8F8F8F] hover:scale-[1.05] transition ease-in-out duration-[100ms] cursor-pointer">
				...
				<h3 class="text-2xl text-center font-semibold">Transaksi</h3>
			</div>
			...
			<div class="bg-white p-6 rounded-lg shadow border-[1.5px] border-[#8F8F8F] hover:scale-[1.05] transition ease-in-out duration-[100ms] cursor-pointer">
				...
				<h3 class="text-2xl text-center font-semibold">Laporan</h3>
			</div>	
		</div>
	</div>
