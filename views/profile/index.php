...
<body class="relative min-h-screen pb-[200px] bg-fixed bg-no-repeat bg-center bg-cover bg-[#E7F4E4]">
    ...
    <div class="container mx-auto p-6 mt-12">
        ...
        <div class="flex justify-end mb-6">
            <a href="edit.php?type=profile&id=<?php echo $row['id'] ?>" class="bg-green-500 text-white px-6 py-2 rounded-lg hover:bg-green-600 transition duration-300">Edit Profil</a>
        </div>
    </div>
