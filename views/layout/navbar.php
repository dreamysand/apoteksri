<nav class="bg-[#101018] text-white p-4 fixed top-0 left-0 right-0 z-[997]">
    ...
    <aside id="sidebar" class="fixed top-0 left-0 h-full bg-[#101018] text-white p-6">
        <nav>
            ...
            <a href="#" class="block py-2 px-4 rounded hover:bg-gray-700 transition ease-in-out duration-[150ms]">Kategori</a>
            <a href="#" class="block py-2 px-4 rounded hover:bg-gray-700 transition ease-in-out duration-[150ms]">Obat-obatan</a>
