...
CREATE DATABASE IF NOT EXISTS `apoteksri` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `apoteksri`;
...
CREATE TABLE IF NOT EXISTS `golongan` (
  ...
  `perlu_resep` enum('Ya','Tidak') CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL DEFAULT 'Tidak',
...
CREATE TABLE IF NOT EXISTS `resep` (
  ...
  `status` enum('Belum Dikonfirmasi','Diterima','Ditolak') CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL DEFAULT 'Belum Dikonfirmasi',
